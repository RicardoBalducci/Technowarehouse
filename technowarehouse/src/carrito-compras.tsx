...
function Carrito(){
    return(
        ...
        <img className="dispositivo" src="ico7.png" height= "65" width="120" alt="icono"></img>
            ...
            <footer>
                <div className="pie">
            <img className="logo-footer" src="logo.png" alt="logo"></img>
            <h2 className="titulo-footer">TECHNO WAREHOUSE</h2>
            </div>
            <p className="etiqueta-carrito">© 2024 Techno Warehouse. Todos los derechos reservados.</p>
            </footer>
